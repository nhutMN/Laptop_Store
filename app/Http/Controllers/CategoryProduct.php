...
class CategoryProduct extends Controller
{
    ...
    public function all_category_product(){
        ...
        return view('admin.admin_dashboard')->with('admin.category_product.all_category_product',$manager_category_product);
    }
    ...
    public function edit_category_product($category_product_id){
        ...
        return view('admin.admin_dashboard')->with('admin.category_product.edit_category_product',$manager_category_product);
    }
